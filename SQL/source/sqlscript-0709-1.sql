REM   Script: 2024-07-09-1.sql
REM   2024-07-09-1.sql - JOIN
...
SELECT E.ENAM, D.DNAME, S.GRADE 
FROM EMP E INNER JOIN DEPT D INNER JOIN SALGRADE S 
ON E.DEPTNO = DEPT.DEPTNO AND E.SAL BETWEEN S.LOSAL AND S.HISAL;

SELECT E.ENAM, D.DNAME, S.GRADE 
FROM EMP E INNER JOIN DEPT D AND SALGRADE S 
ON E.DEPTNO = DEPT.DEPTNO AND E.SAL BETWEEN S.LOSAL AND S.HISAL;
...
SELECT E.ENAM, D.DNAME, S.GRADE 
FROM EMP E INNER JOIN DEPT ON E.DEPTNO = DEPT.DEPTNO AND 
...
SELECT E.ENAM, D.DNAME, S.GRADE 
FROM EMP E  
    INNER JOIN DEPT ON E.DEPTNO = D.DEPTNO 
    INNER JOIN SALGRADE S ON E.SAL BETWEEN S.LOSAL AND S.HISAL;

SELECT E.ENAM, D.DNAME, S.GRADE 
FROM EMP E INNER JOIN DEPT INNER JOIN SALGRADE S 
